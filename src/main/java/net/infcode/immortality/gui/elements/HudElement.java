...
public abstract class HudElement {
    ...
    public static void drawCustomBar(MatrixStack ms, int x, int y, int width, int height, double value, int colorGroundLight, int colorGroundDark, int colorBarLight, int colorBarDark, boolean outlined, int colorOutline) {
        ...
        drawRect(ms, x + offset, y + offset, percentFilled, halvedFilledHeight, colorBarLight);
        drawRect(ms, x + offset, y + offset + halvedFilledHeight, percentFilled, filledHeight - halvedFilledHeight, colorBarDark);

        if (filledWidth - percentFilled > 0) {
            drawRect(ms, x + offset + percentFilled, y + offset, filledWidth - percentFilled, halvedFilledHeight, colorGroundLight);
            drawRect(ms, x + offset + percentFilled, y + offset + halvedFilledHeight, filledWidth - percentFilled, filledHeight - halvedFilledHeight, colorGroundDark);
        }
    }
